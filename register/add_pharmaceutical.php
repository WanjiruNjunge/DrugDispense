...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
	...
	// Prepare and execute the query to insert the pharmaceutical data into the database
	$query = "INSERT INTO pharmaceutical (title, location, email, phoneNumber)
		VALUES ('$title', '$location', '$email', '$phoneNumber')";

	if (mysqli_query($connection, $query)) {
		$successMessage = "Pharmaceutical added successfully!";
...
<html>
<head>
    <title>Add Pharmaceutical</title>
...
?>
	...
	<h1 class="mb-4">Add Pharmaceutical</h1>
