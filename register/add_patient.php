...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_FILES['profileImage']) && $_FILES['profileImage']['error'] === UPLOAD_ERR_OK) {
        ...
        $imageUrl = '../static/images/users/patients/' . $fileName;
    ...
    $query = "INSERT INTO patient ( name, email, phoneNumber, ssn, gender, imageUrl , dateOfBirth, passwordHash)
              VALUES ('$name', '$email', '$phoneNumber', '$ssn', '$gender', '$imageUrl','$dateOfBirth', '$password')";
