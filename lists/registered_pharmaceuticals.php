...
// Prepare and execute the query to fetch pharmaceuticals data
...
?>
	...
	<h1 class="mb-4">Registered Pharmaceuticals</h1>
...
?>
		    <tr>
			<td><?php echo $pharmaceuticalId; ?></td>
			<td><a href="../profiles/pharmaceutical.php?pharmaceuticalId=<?php echo $pharmaceuticalId; ?>"><?php echo $title; ?></a></td>
